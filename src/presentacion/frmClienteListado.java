 ...
 * @author USER
 */
public class frmClienteListado extends javax.swing.JFrame {
        ...
        if (node == null) {
         ...
         try {
            ...
            if (node.getLevel() == 1) {
                ...
                resultado = obj.listarPorDepartamento(codDep);
                //this.resultado = new cliente().listarPorDepartamento(node.getUserObject().toString());
            } 
                ...
                resultado = obj.listarPorProvincia(codDep, codPro);
                //this.resultado = new cliente().listarPorProvincia(node.getUserObject().toString());
                ...
                resultado = obj.listarPorDistrito(codDep, codPro, codDis);
//                this.resultado = new cliente().listarPorDistrito(node.getUserObject().toString());
            } 
            else {
                cargarDatosConsulta();
            }
